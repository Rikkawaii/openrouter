...
public interface LlmClientAdapter {
     ...
     */
    Mono<ChatCompletionResponse> chat(ChatCompletionRequest request, ChannelConfig channel);

    Flux<String> streamChat(ChatCompletionRequest request, ChannelConfig channel);
